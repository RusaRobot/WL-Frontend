        ...
        >
          ...
          <Link to="/detail/40">
            <Box>
              ...
              <Text>
                Tak ada hamparan bunga mawar. Tak ada pelayaran yang
                menyenangkan. Kuanggap semuanya sebagai tantangan di hadapan
                seluruh umat manusia. Dan aku tak akan kalah darinya.
              </Text>
            </Box>
          </Link>
          <Link to="/detail/34">
